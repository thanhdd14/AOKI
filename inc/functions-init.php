...
if (! function_exists('oc_enqueue')) {
    function oc_enqueue()
    {
        ...
        if ($is_production) {
            ...
            wp_enqueue_script('jquery-js', ($uri . '/js/jquery-3.3.1.min.js'), array('jquery', 'boostrap-js'), $asset_version, true);
            wp_enqueue_script('slick-js', ($uri . '/js/slick.min.js'), array('jquery', 'boostrap-js'), $asset_version, true);
            wp_enqueue_script('match-js', ($uri . '/js/jquery.matchHeight-min.js'), array('jquery', 'boostrap-js'), $asset_version, true);
